<?php
  if ($_SERVER['REQUEST_METHOD'] == 'POST'){
     ...
     $main1_checked = false;
     /*gıda*/
     if($_POST["pirinc"]){ $sub1_checked=true; } if($_POST["bulgur"]){ $sub1_checked=true; } 
     if($_POST["nohut"]){ $sub1_checked=true; } if($_POST["fasulye"]){ $sub1_checked=true; } 
     if($_POST["bugday"]){ $sub1_checked=true; }
     if ($sub1_checked) { $sub_category_tags .= "Bakliyat,"; }
     $sub1_checked = false;
     if($_POST["salca"]){ $sub1_checked=true; } if($_POST["siviyag"]){ $sub1_checked=true; }
     if($_POST["un"]){ $sub1_checked=true; } if($_POST["yumurta"]){ $sub1_checked=true; }
     if($_POST["makarna"]){ $sub1_checked=true; }
     if ($sub1_checked) { $sub_category_tags .= "KonserveVeYemekMalzemeleri,"; }
     $sub1_checked = false;
     if($_POST["et"]){ $sub1_checked=true; } if($_POST["tavuk"]){ $sub1_checked=true; }
     if($_POST["balik"]){ $sub1_checked=true; }
     if ($sub1_checked) { $sub_category_tags .= "Et Ürünleri,"; }
     $sub1_checked = false;
     if($_POST["su"]){ $sub1_checked = true; } if($_POST["sut"]){ $sub1_checked = true; } 
     if($_POST["cay"]){ $sub1_checked = true; } if($_POST["yogurt"]){ $sub1_checked = true; }
     if ($sub1_checked) { $sub_category_tags .= "İçecekler,"; }
     $sub1_checked = false;
        
     if (!empty($sub_category_tags)) { $main_category_tags .= "Gıda,"; }
/*giyecekler*/
     if($_POST["tisort_small"]){ $sub1_checked = true; } if($_POST["tisort_medium"]){ $sub1_checked = true; }
     if($_POST["tisort_large"]){ $sub1_checked = true; } if($_POST["tisort_xlarge"]){ $sub1_checked = true; } 
     if ($sub1_checked) { $sub_category_tags .= "Tişört,"; $main1_checked=true; }      
     $sub1_checked = false;       
     if($_POST["kazak_small"]){ $sub1_checked = true; } if($_POST["kazak_medium"]){ $sub1_checked = true; }
     if($_POST["kazak_large"]){ $sub1_checked = true; } if($_POST["kazak_xlarge"]){ $sub1_checked = true; }  
     if ($sub1_checked) { $sub_category_tags .= "Kazak,"; $main1_checked=true; }      
     $sub1_checked = false;       
     if($_POST["pantolon_small"]){ $sub1_checked = true; } if($_POST["pantolon_medium"]){ $sub1_checked = true; }
     if($_POST["pantolon_large"]){ $sub1_checked = true; } if($_POST["pantolon_xlarge"]){ $sub1_checked = true; }  
     if ($sub1_checked) { $sub_category_tags .= "Pantolon+,"; $main1_checked=true; }      
     $sub1_checked = false;       
     if($_POST["kaban_mont_small"]){ $sub1_checked = true; } if($_POST["kaban_mont_medium"]){ $sub1_checked = true; } 
     if($_POST["kaban_mont_large"]){ $sub1_checked = true; } if($_POST["kaban_mont_xlarge"]){ $sub1_checked = true; }  
     ...
     $main1_checked=false;
     /*temel eşyalar*/
     if($_POST["su_isitici"]){ $sub1_checked = true; } if($_POST["isitici"]){ $sub1_checked = true; }
     if($_POST["bilgisayar"]){ $sub1_checked = true; } if($_POST["projeksiyon"]){ $sub1_checked = true; }
     if ($sub1_checked) { $sub_category_tags .= "Elektrikli Aletler,"; $main1_checked=true; }      
     $sub1_checked = false;       
     if($_POST["camasir_makinesi"]){ $sub1_checked = true; } if($_POST["bulasik_makinesi"]){ $sub1_checked = true; }
     if($_POST["ocak"]){ $sub1_checked = true; } if($_POST["fırın"]){ $sub1_checked = true; }
     if ($sub1_checked) { $sub_category_tags .= "Beyaz Eşya,"; $main1_checked=true; }      
     $sub1_checked = false;       
     if($_POST["battaniye"]){ $sub1_checked = true; } if($_POST["bebek_bezi"]){ $sub1_checked = true; }
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="fasulye" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="bugday" /><label><input type="checkbox" />
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="checkbox" id="salca" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="siviyag" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="un" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="yumurta" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="makarna" /><label><input type="checkbox" />
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="checkbox" id="et" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="tavuk" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="balik" /><label><input type="checkbox" />
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="checkbox" id="su" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                          <input type="checkbox" id="sut" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="cay" /><label><input type="checkbox" />
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="yogurt" /><label><input type="checkbox" />
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="kazak_medium" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="kazak_large" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="kazak_xlarge" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="checkbox" id="pantolon_small" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="pantolon_large" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="pantolon_xlarge" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                          <input type="checkbox" id="kaban_mont_small" checked="unchecked" /><label><input type="checkbox" /><span></span>
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="kaban_mont_medium" checked="unchecked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                            ...
                                                            <label><input type="checkbox" /><span></span></label><label class="items" for="kaban_mont_large">Large</label> 
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="kaban_mont_xlarge" checked="unchecked" /><label><input type="checkbox" /><span></span></label>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="checkbox" id="su_isitici" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                                            <input type="checkbox" id="isitici" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                                            <input type="checkbox" id="bilgisayar" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                                            <input type="checkbox" id="projeksiyon" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="checkbox" id="camasir_makinesi" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                                            <input type="checkbox" id="bulasik_makinesi" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                                            <input type="checkbox" id="ocak" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                        ...
                                                        <li>
                                                                            <input type="checkbox" id="fırın" checked="checked" /><label><input type="checkbox" /><span></span></label>
                                                ...
                                                <li>
                                                  ...
                                                  <ul>
                                                      <li>
                                                          <input type="checkbox" id="battaniye"  /><label><input type="checkbox" /><span></span></label>
                                                      ...
                                                      <li>
                                                          <input type="checkbox" id="bebek_bezi" /><label><input type="checkbox" /><span></span></label>
