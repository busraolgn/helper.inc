      ...
      <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
        ...
        <li role="presentation">
          <a href="#samsa" role="tab" id="samsa-tab" data-toggle="tab" aria-controls="samsa">
            <span class="textProfile">Ayarlarım</span>
          </a>
        </li>
      </ul>
...
<div class="container target">
    <div class="row">
        <div class="col-sm-10">
             <h1 class="">Ata Demirer</h1>
         <br><br>
         <button type="button" class="btn btn-info">Mesaj Gonder!</button>
        </div>
      <div class="col-sm-2"><a href="/users" class="pull-right"><img title="profile image" class="img-circle img-responsive" src="http://gcube.milliyet.com.tr/Detail/2014/01/16/-evimin-yeri-belli-olmasin--ata-demirer-cihangir-1409731.jpg"></a>
  ...
  <br>
    <div class="row">
        <div class="col-sm-3">
            ...
            <ul class="list-group">
                <li class="list-group-item text-muted">Aktiviteler <i class="fa fa-dashboard fa-1x"></i>

                </li>
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">Açılan Kampanya</strong></span> 12</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">Favoriler</strong></span> 13</li>
        ...
        <div class="col-sm-9" contenteditable="false" style="">
            <div class="panel panel-default">
                <div class="panel-heading">Demirer'in Profili</div>
                <div class="panel-body"> Su anda islem yapılan 12 kampanyası var.
      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" role="form">
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" value="Ata">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Soyad:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" value="Demirer">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Email:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" value="ademirer@gmail.com">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input class="form-control" type="text" value="ademirer">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input type="button" class="btn btn-primary" value="Değişiklikleri Kaydet">
              <span></span>
